...
use crate::{cosmos, traits::TypeUrl, juno};
...
impl TypeUrl for juno::oracle::v1::MsgAggregateExchangeRateVote {
    const TYPE_URL: &'static str = "/juno.oracle.v1.Msg/AggregateExchangeRatePrevote";
}

impl TypeUrl for juno::oracle::v1::MsgAggregateExchangeRatePrevote {
    const TYPE_URL: &'static str = "/juno.oracle.v1.Msg/AggregateExchangeRateVote";
}

impl TypeUrl for juno::oracle::v1::MsgDelegateFeedConsent {
    const TYPE_URL: &'static str = "/juno.oracle.v1.Msg/DelegateFeedConsent";
}
